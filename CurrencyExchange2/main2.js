const currencyRatio = {
    VND: {
        ...
        VND: 1,
        unit: "동",
        img: "[https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Vietnam.svg" +
                "/2560px-Flag_of_Vietnam.svg.png](https://upload.wikimedia.org/wikipedia/common" +
                "s/thumb/2/21/Flag_of_Vietnam.svg/2560px-Flag_of_Vietnam.svg.png)"
    },
    USD: {
        USD: 1,
        KRW: 1182.35,
        VND: 23235.5,
        unit: "달러",
        img: "[https://cdn-icons-png.flaticon.com/512/555/555526.png](https://cdn-icons-png." +
                "flaticon.com/512/555/555526.png)"
    },
    KRW: {
        USD: 0.00085,
        KRW: 1,
        VND: 19.47,
        unit: "원",
        img: "[https://cdn.countryflags.com/thumbs/south-korea/flag-400.png](https://cdn.cou" +
                "ntryflags.com/thumbs/south-korea/flag-400.png)"
    }
};
...
document.querySelectorAll("#from-currency-list li").forEach(function (item) {
    ...
    function renderKoreanNumber(from, to) {
        document
            .getElementById("fromNumToKorea")
            .textContent = readNum(from) + currencyRatio[fromCurrency]
            .unit;
        document
            .getElementById("toNumToKorea")
            .textContent = readNum(to) + currencyRatio[toCurrency]
            .unit;
    }
